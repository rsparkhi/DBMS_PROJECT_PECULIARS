...
// if ($field == 'dept_name' or 'dept_location'){
//     $sql = "update department set ".$field." = '".$value."' where emp_id = ".$employ_id;
// }
// if ($field == 'dept_id'){
//     $sql = "update department set ".$field." = '".$value."' where emp_id = ".$employ_id;
//     $sql = "update employees set ".$field." = '".$value."' where emp_id = ".$employ_id;   
// }
if ($field == 'emp_mobile' or $field == 'salary'){
    $sql = "update employees set ".$field." = ".$value." where emp_id = ".$employ_id;
}
else{
    $sql = "update employees set ".$field." = '".$value."' where emp_id = ".$employ_id;
